...
/* package logMonoid-0.1.0.0 */
#ifndef VERSION_logMonoid
#define VERSION_logMonoid "0.1.0.0"
#endif /* VERSION_logMonoid */
#ifndef MIN_VERSION_logMonoid
#define MIN_VERSION_logMonoid(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_logMonoid */
...
#define CURRENT_COMPONENT_ID "logMonoid-0.1.0.0-Fsr7heAfSvtIrUJjBaka1c-logMonoid"
