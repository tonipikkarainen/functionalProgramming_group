...
/* package exCyclesMonoid-0.1.0.0 */
#ifndef VERSION_exCyclesMonoid
#define VERSION_exCyclesMonoid "0.1.0.0"
#endif /* VERSION_exCyclesMonoid */
#ifndef MIN_VERSION_exCyclesMonoid
#define MIN_VERSION_exCyclesMonoid(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_exCyclesMonoid */
...
#define CURRENT_COMPONENT_ID "exCyclesMonoid-0.1.0.0-58Lj6fDbhcSBuVEpP5Ml2j-exCyclesMonoid"
