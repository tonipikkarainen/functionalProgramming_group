...
/* package exLogMonoid-0.1.0.0 */
#ifndef VERSION_exLogMonoid
#define VERSION_exLogMonoid "0.1.0.0"
#endif /* VERSION_exLogMonoid */
#ifndef MIN_VERSION_exLogMonoid
#define MIN_VERSION_exLogMonoid(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_exLogMonoid */
...
#define CURRENT_COMPONENT_ID "exLogMonoid-0.1.0.0-GqOYriIoRnJAm4VWepjy4U-exLogMonoid"
