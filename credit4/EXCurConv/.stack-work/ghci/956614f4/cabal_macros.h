...
/* package EXCurConv-0.1.0.0 */
#ifndef VERSION_EXCurConv
#define VERSION_EXCurConv "0.1.0.0"
#endif /* VERSION_EXCurConv */
#ifndef MIN_VERSION_EXCurConv
#define MIN_VERSION_EXCurConv(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EXCurConv */
...
#define CURRENT_COMPONENT_ID "EXCurConv-0.1.0.0-BhopDtRjVY3JmGaBfE30DX-EXCurConv"
