...
/* package extyjson-0.1.0.0 */
#ifndef VERSION_extyjson
#define VERSION_extyjson "0.1.0.0"
#endif /* VERSION_extyjson */
#ifndef MIN_VERSION_extyjson
#define MIN_VERSION_extyjson(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_extyjson */
...
#define CURRENT_COMPONENT_ID "extyjson-0.1.0.0-74QRAfrkQAN8MeV2MqhMyF-extyjson"
