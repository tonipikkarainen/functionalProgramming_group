...
/* package EXOperators-0.1.0.0 */
#ifndef VERSION_EXOperators
#define VERSION_EXOperators "0.1.0.0"
#endif /* VERSION_EXOperators */
#ifndef MIN_VERSION_EXOperators
#define MIN_VERSION_EXOperators(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EXOperators */
...
#define CURRENT_COMPONENT_ID "EXOperators-0.1.0.0-3HoXsuWcrnX61eeZFoAUsu-EXOperators"
