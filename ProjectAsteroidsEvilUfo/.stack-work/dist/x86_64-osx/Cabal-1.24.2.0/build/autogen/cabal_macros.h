...
/* package ProjectAsteroidsFancier-0.1.0.1 */
#define VERSION_ProjectAsteroidsFancier "0.1.0.1"
#define MIN_VERSION_ProjectAsteroidsFancier(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "ProjectAsteroidsFancier-0.1.0.1"

#define CURRENT_PACKAGE_KEY "ProjectAsteroidsFancier-0.1.0.1"
