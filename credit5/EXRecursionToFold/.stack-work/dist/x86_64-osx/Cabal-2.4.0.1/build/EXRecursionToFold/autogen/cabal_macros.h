...
/* package EXRecursionToFold-0.1.0.0 */
#ifndef VERSION_EXRecursionToFold
#define VERSION_EXRecursionToFold "0.1.0.0"
#endif /* VERSION_EXRecursionToFold */
#ifndef MIN_VERSION_EXRecursionToFold
#define MIN_VERSION_EXRecursionToFold(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EXRecursionToFold */
...
#define CURRENT_COMPONENT_ID "EXRecursionToFold-0.1.0.0-2Y7xVRONiazIjZpKEjov6F-EXRecursionToFold"
