...
/* package IOoperations-0.1.0.0 */
#ifndef VERSION_IOoperations
#define VERSION_IOoperations "0.1.0.0"
#endif /* VERSION_IOoperations */
#ifndef MIN_VERSION_IOoperations
#define MIN_VERSION_IOoperations(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_IOoperations */
...
#define CURRENT_COMPONENT_ID "IOoperations-0.1.0.0-IYtK2qz3nHv5Ogdp01ooJA-IOoperations"
