...
/* package EXConDecon-0.1.0.0 */
#ifndef VERSION_EXConDecon
#define VERSION_EXConDecon "0.1.0.0"
#endif /* VERSION_EXConDecon */
#ifndef MIN_VERSION_EXConDecon
#define MIN_VERSION_EXConDecon(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EXConDecon */
...
#define CURRENT_COMPONENT_ID "EXConDecon-0.1.0.0-I0TRfbzf7FYCEecUgJ3BJ8-EXConDecon"
