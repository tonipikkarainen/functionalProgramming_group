...
/* package testiProjekti-0.1.0.0 */
#ifndef VERSION_testiProjekti
#define VERSION_testiProjekti "0.1.0.0"
#endif /* VERSION_testiProjekti */
#ifndef MIN_VERSION_testiProjekti
#define MIN_VERSION_testiProjekti(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_testiProjekti */
...
#define CURRENT_COMPONENT_ID "testiProjekti-0.1.0.0-7ySCvpONybD1YmxVxbSwB-testiProjekti"
