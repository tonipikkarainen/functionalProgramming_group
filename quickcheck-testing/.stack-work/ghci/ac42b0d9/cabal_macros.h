...
/* package quickcheck-testing-0.1.0.0 */
#ifndef VERSION_quickcheck_testing
#define VERSION_quickcheck_testing "0.1.0.0"
#endif /* VERSION_quickcheck_testing */
#ifndef MIN_VERSION_quickcheck_testing
#define MIN_VERSION_quickcheck_testing(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_quickcheck_testing */
...
#define CURRENT_COMPONENT_ID "quickcheck-testing-0.1.0.0-H1WVQWguBKmCnkOOwxVxec-quickcheck-testing"
