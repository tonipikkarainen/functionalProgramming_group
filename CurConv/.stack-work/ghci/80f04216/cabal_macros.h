...
/* package CurConv-0.1.0.0 */
#ifndef VERSION_CurConv
#define VERSION_CurConv "0.1.0.0"
#endif /* VERSION_CurConv */
#ifndef MIN_VERSION_CurConv
#define MIN_VERSION_CurConv(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CurConv */
...
#define CURRENT_COMPONENT_ID "CurConv-0.1.0.0-FFTSJpQvTynHwpUv0bf4t0-CurConv"
